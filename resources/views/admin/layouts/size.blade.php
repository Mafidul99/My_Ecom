...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{url('admin/size/manage_size')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0">
                        <i class="bx bxs-plus-square"></i>Add Sizes</a>
                </div>
            </div>
        </div>
        <!--end breadcrumb-->
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex order-actions">
                                        ...
                                        <a href="{{url('admin/size/delete/')}}/{{$list->id}}" class="ms-3">
